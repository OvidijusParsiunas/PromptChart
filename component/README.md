...
## :construction_worker: To create your own PromptChart component

```
# Clone the project locally (optionally use --depth 1 for quicker download):
$ git clone --depth 1 https://github.com/OvidijusParsiunas/PromptChart.git
...
# Bundle the component into a single file (dist/promptChart.bundle.js):
