...
A complete FastAPI backend for PromptChart that converts natural language prompts into chart specifications using OpenAI.
...
**3. Include the router in your FastAPI app (e.g., `app.py`):**
...
from src.routes import create_chart_router
