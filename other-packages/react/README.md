...
function App() {
  return <PromptChart endpoint="http://localhost:3000/api/chart" prompt="Show monthly sales for 2024" autoFetch={true} />;
}
```
...
```tsx
<PromptChart prompt="Show quarterly revenue by region" demo={true} autoFetch={true} />
```
